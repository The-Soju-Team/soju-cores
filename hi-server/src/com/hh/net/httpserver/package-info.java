...
/**
   ...
   using the API.
   <p>
   Programmers must implement the {@link com.hh.net.httpserver.HttpHandler} interface. This interface
   ...
   represented by the {@link com.hh.net.httpserver.HttpExchange} class.
   The {@link com.hh.net.httpserver.HttpServer} class is used to listen for incoming TCP connections
   ...
   <p>
   The {@link com.hh.net.httpserver.HttpExchange} class encapsulates everything an application needs to
   process incoming requests and to generate appropriate responses.
   <p>
   Registering a handler with a HttpServer creates a {@link com.hh.net.httpserver.HttpContext} object and
   {@link com.hh.net.httpserver.Filter}
   ...
   <p>
   For sensitive information, a {@link com.hh.net.httpserver.HttpsServer} can
   be used to process "https" requests secured by the SSL or TLS protocols.
   A HttpsServer must be provided with a
   {@link com.hh.net.httpserver.HttpsConfigurator} object, which contains an
