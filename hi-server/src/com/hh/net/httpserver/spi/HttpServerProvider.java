...
public abstract class HttpServerProvider {
    ...
    private static boolean loadProviderFromProperty() {
        String cn = System.getProperty("com.hh.net.httpserver.HttpServerProvider");
        if (cn == null)
            return false;
        try {
     ...
     *   <tt>com.hh.net.httpserver.HttpServerProvider</tt> is defined then it is
     ...
     *   <tt>com.hh.net.httpserver.HttpServerProvider</tt> in the resource
                    ...
                    .doPrivileged(new PrivilegedAction<Object>() {
                        public Object run() {
                            ...
                            if (loadProviderAsService())
                                return provider;
                            provider = new com.hh.net.impl.httpserver.DefaultHttpServerProvider();
                            return provider;
                        }
                    });
        }
