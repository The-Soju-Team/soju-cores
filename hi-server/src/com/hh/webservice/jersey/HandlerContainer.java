 ...
 */
public class HandlerContainer implements HttpHandler, Container {

    private static final Logger LOGGER = Logger.getLogger(HandlerContainer.class.getName());
     ...
     */
    public HandlerContainer(final Application application) {
