...
public class UserDaoImpl implements UserDao {
	...
	public List<List> searchUser(Integer numberRow, Integer pageLength, String name, String msisdn, String fullName,
			Integer userType, Date fromDate, Date toDate) throws SQLException {
