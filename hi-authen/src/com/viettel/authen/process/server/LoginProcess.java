...
public class LoginProcess extends ServerProcess {
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(LoginProcess.class.getName());
    private static final org.apache.log4j.Logger logKafka = org.apache.log4j.Logger.getLogger("kafkaLogger");
    ...
    public static final String[] NOT_ALLOWED_IP = new String[]{"6", "Your account is not allowed to use on this IP"};
