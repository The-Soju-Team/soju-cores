...
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.BASE64EncoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.QPEncoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.QDecoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.BEncoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.BASE64DecoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.LineInputStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.QEncoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.UUEncoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.QPDecoderStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.UUDecoderStream;
import java.io.*;
import java.util.*;
...
public class MimeUtility {
    ...
    static {
        ...
        try {
            ...
            InputStream is =
                    com.hh.xml.internal.messaging.saaj.packaging.mime.internet.MimeUtility.class.getResourceAsStream(
