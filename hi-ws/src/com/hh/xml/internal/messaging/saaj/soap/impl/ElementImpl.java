...
import com.hh.webservice.soap.SOAPBodyElement;
...
import com.hh.xml.internal.messaging.saaj.util.NamespaceContextIterator;
import com.hh.xml.internal.messaging.saaj.util.JaxmURI;
...
//            return uri;
    ...
    public void removeContents() {
        ...
        while (currentChild != null) {
            ...
            if (currentChild instanceof com.hh.webservice.soap.Node) {
                ((com.hh.webservice.soap.Node) currentChild).detachNode();
            } else {
    ...
    public String getValue() {
        com.hh.webservice.soap.Node valueNode = getValueNode();
    ...
    protected com.hh.webservice.soap.Node getValueNode() {
        Iterator i = getChildElements();
        while (i.hasNext()) {
            com.hh.webservice.soap.Node n = (com.hh.webservice.soap.Node) i.next();
            if (n.getNodeType() == org.w3c.dom.Node.TEXT_NODE ||
                ...
                // DOM/Xerces.
                return (com.hh.webservice.soap.Node) n;
            }
        }
        return null;
    }
