...
import com.hh.webservice.soap.Node;
import com.hh.webservice.soap.SOAPBody;
...
import static com.hh.webservice.soap.SOAPMessage.CHARACTER_SET_ENCODING;
import com.hh.webservice.soap.SOAPPart;
import com.hh.xml.internal.messaging.saaj.util.ByteInputStream;
import com.hh.xml.internal.messaging.saaj.util.FinalArrayList;
...
import com.hh.xml.internal.messaging.saaj.util.SAAJUtil;
import com.hh.xml.internal.messaging.saaj.packaging.mime.util.ASCIIUtility;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.ParseException;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.MimePullMultipart;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.ContentType;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.ParameterList;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.MimeBodyPart;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.MimeMultipart;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.SharedInputStream;
import com.hh.xml.internal.messaging.saaj.packaging.mime.internet.BMMimeMultipart;
import java.io.*;
import java.util.*;
...
import com.hh.xml.internal.messaging.saaj.packaging.mime.Header;
    ...
    private void verify(String property, Object value) {
        if (property.equalsIgnoreCase(SOAPMessage.WRITE_XML_DECLARATION)) {
            ...
            try {
                ...
                log.log(Level.SEVERE, "SAAJ0591.soap.exception.in.set.property",
                    new Object[] {e.getMessage(), "com.hh.webservice.soap.write-xml-declaration"});
        ...
        if (property.equalsIgnoreCase(SOAPMessage.CHARACTER_SET_ENCODING)) {
            try {
                ...
                log.log(Level.SEVERE, "SAAJ0591.soap.exception.in.set.property",
                    new Object[] {e.getMessage(), "com.hh.webservice.soap.character-set-encoding"});
                throw new RuntimeException(e);
            }
        }
    }
