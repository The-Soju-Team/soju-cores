...
import com.hh.xml.internal.ws.api.pipe.Engine;
import com.hh.xml.internal.ws.api.pipe.Fiber;
import com.hh.xml.internal.ws.api.pipe.FiberContextSwitchInterceptor;
import com.hh.xml.internal.ws.api.pipe.ServerPipeAssemblerContext;
...
import com.hh.xml.internal.ws.api.pipe.TubelineAssembler;
import com.hh.xml.internal.ws.api.pipe.TubelineAssemblerFactory;
import com.hh.xml.internal.ws.fault.SOAPFaultBuilder;
import com.hh.xml.internal.ws.model.wsdl.WSDLProperties;
import com.hh.xml.internal.ws.model.wsdl.WSDLPortImpl;
import com.hh.xml.internal.ws.resources.HandlerMessages;
import com.hh.xml.internal.ws.util.Pool;
import com.hh.xml.internal.ws.util.ServiceFinder;
import com.hh.xml.internal.ws.util.Pool.TubePool;
import com.hh.xml.internal.ws.policy.PolicyMap;
import com.hh.xml.internal.ws.wsdl.OperationDispatcher;
import com.hh.xml.internal.ws.addressing.EPRSDDocumentFilter;
import com.hh.xml.internal.ws.addressing.WSEPRExtension;
...
import com.hh.xml.internal.ws.api.server.EndpointAwareCodec;
import com.hh.xml.internal.ws.api.server.EndpointComponent;
import com.hh.xml.internal.ws.api.server.EndpointReferenceExtensionContributor;
import com.hh.xml.internal.ws.api.server.TransportBackChannel;
import com.hh.xml.internal.ws.api.server.WSEndpoint;
import com.hh.xml.internal.ws.api.server.WSEndpoint.PipeHead;
...
public final class WSEndpointImpl<T> extends WSEndpoint<T> {
    ...
    private static final Logger logger = Logger.getLogger(com.hh.xml.internal.ws.util.Constants.LoggingDomain + ".server.endpoint");
