...
import static com.hh.xml.internal.bind.v2.schemagen.Util.*;
import com.hh.xml.internal.txw2.TXW;
import com.hh.xml.internal.txw2.TypedXmlWriter;
import com.hh.xml.internal.txw2.output.ResultFactory;
import com.hh.xml.internal.txw2.output.XmlSerializer;
import com.hh.xml.internal.txw2.output.TXWResult;
...
import com.hh.xml.internal.ws.wsdl.parser.SOAPConstants;
import com.hh.xml.internal.ws.wsdl.parser.WSDLConstants;
import com.hh.xml.internal.ws.wsdl.writer.document.Binding;
import com.hh.xml.internal.ws.wsdl.writer.document.BindingOperationType;
import com.hh.xml.internal.ws.wsdl.writer.document.Definitions;
import com.hh.xml.internal.ws.wsdl.writer.document.Fault;
import com.hh.xml.internal.ws.wsdl.writer.document.FaultType;
import com.hh.xml.internal.ws.wsdl.writer.document.Import;
import com.hh.xml.internal.ws.wsdl.writer.document.Message;
import com.hh.xml.internal.ws.wsdl.writer.document.Operation;
import com.hh.xml.internal.ws.wsdl.writer.document.ParamType;
import com.hh.xml.internal.ws.wsdl.writer.document.Port;
import com.hh.xml.internal.ws.wsdl.writer.document.PortType;
import com.hh.xml.internal.ws.wsdl.writer.document.Service;
import com.hh.xml.internal.ws.wsdl.writer.document.Types;
import com.hh.xml.internal.ws.wsdl.writer.document.soap.Body;
import com.hh.xml.internal.ws.wsdl.writer.document.soap.BodyType;
import com.hh.xml.internal.ws.wsdl.writer.document.soap.Header;
import com.hh.xml.internal.ws.wsdl.writer.document.soap.SOAPAddress;
import com.hh.xml.internal.ws.wsdl.writer.document.soap.SOAPFault;
import com.hh.xml.internal.ws.util.RuntimeVersion;
import com.hh.xml.internal.ws.policy.jaxws.PolicyWSDLGeneratorExtension;
import com.hh.xml.internal.ws.encoding.soap.streaming.SOAPNamespaceConstants;
...
public class WSDLGenerator {
   ...
   /**
     ...
     * @param binding The {@link com.hh.xml.internal.ws.api.model.soap.SOAPBinding} to add the generated messages to
     */
    protected void generateSOAPMessages(JavaMethodImpl method, com.hh.xml.internal.ws.api.model.soap.SOAPBinding binding) {
...
//        Message message = portDefinitions.message().name(method.getOperation().getName().getLocalPart());
        ...
        com.hh.xml.internal.ws.wsdl.writer.document.Part part;
...
//            System.out.println("param: "+parameter.getIndex()+" name: "+parameter.getName().getLocalPart());
        ...
        for (JavaMethodImpl method : model.getJavaMethods()) {
            if (first) {
                ...
                if (soapVersion == SOAPVersion.SOAP_12){
                    com.hh.xml.internal.ws.wsdl.writer.document.soap12.SOAPBinding soapBinding = binding.soap12Binding();
                    ...
                    com.hh.xml.internal.ws.wsdl.writer.document.soap.SOAPBinding soapBinding = binding.soapBinding();
                    soapBinding.transport(this.binding.getBindingId().getTransport());
                    if (sBinding.getStyle().equals(Style.DOCUMENT))
                        soapBinding.style(DOCUMENT);
                    else
    ...
    protected void generateSOAP12BindingOperation(JavaMethodImpl method, Binding binding) {
        ...
        TypedXmlWriter input = operation.input();
        extension.addBindingOperationInputExtension(input, method);
        com.hh.xml.internal.ws.wsdl.writer.document.soap12.BodyType body = input._element(com.hh.xml.internal.ws.wsdl.writer.document.soap12.Body.class);
        boolean isRpc = soapBinding.getStyle().equals(Style.RPC);
        ...
        if (method.getMEP() != MEP.ONE_WAY) {
            ...
            TypedXmlWriter output = operation.output();
            extension.addBindingOperationOutputExtension(output, method);
            body = output._element(com.hh.xml.internal.ws.wsdl.writer.document.soap12.Body.class);
            body.use(LITERAL);
            if (headerParams.size() > 0) {
                if (bodyParams.size() > 0) {
                    ParameterImpl param = bodyParams.iterator().next();
        ...
        for (CheckedExceptionImpl exception : method.getCheckedExceptions()) {
            Fault fault = operation.fault().name(exception.getMessageName());
            extension.addBindingOperationFaultExtension(fault, method, exception);
            com.hh.xml.internal.ws.wsdl.writer.document.soap12.SOAPFault soapFault = fault._element(com.hh.xml.internal.ws.wsdl.writer.document.soap12.SOAPFault.class).name(exception.getMessageName());
            soapFault.use(LITERAL);
        }
    }
    ...
    protected void generateSOAP12Headers(TypedXmlWriter writer, List<ParameterImpl> parameters, QName message) {
        ...
        for (ParameterImpl headerParam : parameters) {
            com.hh.xml.internal.ws.wsdl.writer.document.soap12.Header header = writer._element(com.hh.xml.internal.ws.wsdl.writer.document.soap12.Header.class);
            header.message(message);
    ...
    protected void generateService() {
        ...
        if(this.binding.getBindingId().getSOAPVersion()== SOAPVersion.SOAP_12){
            com.hh.xml.internal.ws.wsdl.writer.document.soap12.SOAPAddress address = port._element(com.hh.xml.internal.ws.wsdl.writer.document.soap12.SOAPAddress.class);
...
//        paramType.message(new QName(model.getTargetNamespace(), method.getOperation().getLocalName()+RESPONSE));
    ...
    public Result createOutputFile(String namespaceUri, String suggestedFileName) throws IOException {
        ...
        com.hh.xml.internal.ws.wsdl.writer.document.xsd.Import _import = types.schema()._import().namespace(namespaceUri);
