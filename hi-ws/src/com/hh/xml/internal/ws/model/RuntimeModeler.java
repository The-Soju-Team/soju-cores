...
public class RuntimeModeler {
     ...
     * @param wsdlPort {@link com.hh.xml.internal.ws.api.model.wsdl.WSDLPort}
    ...
    private static final Logger logger =
        Logger.getLogger(com.hh.xml.internal.ws.util.Constants.LoggingDomain + ".server");
...
/*        if (clazz == portClass) {
    ...
    protected void processMethod(Method method) {
        ...
        if (methodBinding != null) {
            com.hh.xml.internal.ws.model.soap.SOAPBindingImpl mySOAPBinding = createBinding(methodBinding);
            ...
            com.hh.xml.internal.ws.model.soap.SOAPBindingImpl sb = new com.hh.xml.internal.ws.model.soap.SOAPBindingImpl(defaultBinding);
            if (action != null)
