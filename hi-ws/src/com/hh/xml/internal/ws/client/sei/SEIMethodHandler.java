...
/**
 * {@link com.hh.xml.internal.ws.client.sei.MethodHandler} that handles synchronous method invocations.
 *
 * <p>
 * This class mainly performs the following two tasks:
 * <ol>
 *  <li>Accepts Object[] that represents arguments for a Java method,
 *      and creates {@link com.hh.xml.internal.ws.message.jaxb.JAXBMessage} that represents a request message.
 *  <li>Takes a {@link com.hh.xml.internal.ws.api.message.Message that represents a response,
 *      and extracts the return value (and updates {@link javax.xml.ws.Holder }s.)
 * </ol>
 *
 * <h2>Creating {@link com.hh.xml.internal.ws.message.jaxb.JAXBMessage }</h2>
 * <p>
 * At the construction time, we prepare {@link com.hh.xml.internal.ws.client.sei.BodyBuilder} and {@link com.hh.xml.internal.ws.client.sei.MessageFiller}s
 * that know how to move arguments into a {@link com.hh.xml.internal.ws.api.message.Message }.
...
abstract class SEIMethodHandler extends MethodHandler {
    ...
    /**
     * Creates a request {@link com.hh.xml.internal.ws.message.jaxb.JAXBMessage} from method arguments.
