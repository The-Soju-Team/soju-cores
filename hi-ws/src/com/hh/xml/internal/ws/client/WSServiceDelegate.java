...
import com.hh.xml.internal.ws.Closeable;
...
import com.hh.xml.internal.ws.api.client.ServiceInterceptor;
import com.hh.xml.internal.ws.api.client.ServiceInterceptorFactory;
import com.hh.xml.internal.ws.api.pipe.Stubs;
import com.hh.xml.internal.ws.api.server.Container;
import com.hh.xml.internal.ws.api.server.ContainerResolver;
...
import com.hh.xml.internal.ws.client.HandlerConfigurator.AnnotationConfigurator;
import com.hh.xml.internal.ws.client.HandlerConfigurator.HandlerResolverImpl;
import com.hh.xml.internal.ws.client.sei.SEIStub;
import com.hh.xml.internal.ws.developer.WSBindingProvider;
import com.hh.xml.internal.ws.developer.UsesJAXBContextFeature;
import com.hh.xml.internal.ws.model.AbstractSEIModelImpl;
import com.hh.xml.internal.ws.model.RuntimeModeler;
...
import com.hh.xml.internal.ws.resources.ProviderApiMessages;
import com.hh.xml.internal.ws.util.JAXWSUtils;
import com.hh.xml.internal.ws.util.ServiceConfigurationError;
import com.hh.xml.internal.ws.util.ServiceFinder;
import static com.hh.xml.internal.ws.util.xml.XmlUtil.createDefaultCatalogResolver;
...
import com.hh.webservice.ws.*;
import com.hh.webservice.ws.handler.HandlerResolver;
...
public class WSServiceDelegate extends WSService {
   ...
   private final Map<QName,SEIPortInfo> seiContext = new HashMap<QName,SEIPortInfo>();
    ...
    /**
     * Parses the WSDL and builds {@link com.hh.xml.internal.ws.api.model.wsdl.WSDLModel}.
