...
import com.hh.xml.internal.ws.message.AttachmentUnmarshallerImpl;
...
public class SAAJMessage extends Message {
    ...
    /**
     * Creates a copy of a {@link com.hh.xml.internal.ws.api.message.Message}.
     * <p/>
     * <p/>
     * This method creates a new {@link com.hh.xml.internal.ws.api.message.Message} whose header/payload/attachments/properties
     * are identical to this {@link com.hh.xml.internal.ws.api.message.Message}. Once created, the created {@link com.hh.xml.internal.ws.api.message.Message}
     * and the original {@link com.hh.xml.internal.ws.api.message.Message} behaves independently --- adding header/
     * attachment to one {@link com.hh.xml.internal.ws.api.message.Message} doesn't affect another {@link com.hh.xml.internal.ws.api.message.Message}
     * at all.
     * <p/>
     * <h3>Design Rationale</h3>
     * <p/>
     * Since a {@link com.hh.xml.internal.ws.api.message.Message} body is read-once, sometimes
     * (such as when you do fail-over, or WS-RM) you need to
     * create an idential copy of a {@link com.hh.xml.internal.ws.api.message.Message}.
     * <p/>
     * <p/>
     * The actual copy operation depends on the layout
     * of the data in memory, hence it's best to be done by
     * the {@link com.hh.xml.internal.ws.api.message.Message} implementation itself.
     */
    public Message copy() {
        try {
            if (!parsedMessage) {
    ...
    private class SAAJAttachment implements Attachment {
        ...
        /**
         * Writes this attachment to the given {@link com.hh.webservice.soap.SOAPMessage}.
         */
