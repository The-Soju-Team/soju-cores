...
import com.hh.xml.internal.ws.encoding.ContentType;
import com.hh.xml.internal.ws.encoding.MimeMultipartParser;
import com.hh.xml.internal.ws.encoding.XMLHTTPBindingCodec;
...
import com.hh.xml.internal.ws.util.StreamUtils;
        ...
        if (msg instanceof MessageDataSource) {
            ...
            if (atts != null && !atts.isEmpty()) {
                ...
                try {
                    ...
                    com.hh.xml.internal.ws.api.pipe.ContentType ct = codec.getStaticContentType(new Packet(msg));
