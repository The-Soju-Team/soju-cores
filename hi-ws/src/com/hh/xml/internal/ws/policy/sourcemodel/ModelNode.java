...
package com.hh.xml.internal.ws.policy.sourcemodel;

import com.hh.xml.internal.ws.policy.privateutil.LocalizationMessages;
...
/**
 * The general representation of a single node within a {@link com.hh.xml.internal.ws.policy.sourcemodel.PolicySourceModel} instance.
 * The model node is created via factory methods of the {@link com.hh.xml.internal.ws.policy.sourcemodel.PolicySourceModel} instance.
 * It may also hold {@link com.hh.xml.internal.ws.policy.sourcemodel.AssertionData} instance in case its type is {@code ModelNode.Type.ASSERTION}.
 *
