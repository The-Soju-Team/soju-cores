...
import com.hh.xml.internal.ws.addressing.WsaTubeHelper;
...
import com.hh.xml.internal.ws.message.stream.OutboundStreamHeader;
...
public enum AddressingVersion {
    ...
    W3C("http://www.w3.org/2005/08/addressing",
        ...
        public WsaTubeHelper getWsaHelper(WSDLPort wsdlPort, SEIModel seiModel, WSBinding binding) {
            return new com.hh.xml.internal.ws.addressing.WsaTubeHelperImpl(wsdlPort, seiModel, binding);
        }
    ...
    MEMBER("http://schemas.xmlsoap.org/ws/2004/08/addressing",
        ...
        @Override
        public WsaTubeHelper getWsaHelper(WSDLPort wsdlPort, SEIModel seiModel, WSBinding binding) {
            return new com.hh.xml.internal.ws.addressing.v200408.WsaTubeHelperImpl(wsdlPort, seiModel, binding);
        }
