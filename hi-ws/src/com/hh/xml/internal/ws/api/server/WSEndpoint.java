...
import com.hh.xml.internal.ws.api.config.management.EndpointCreationAttributes;
import com.hh.xml.internal.ws.api.config.management.ManagedEndpointFactory;
...
public abstract class WSEndpoint<T> {
    ...
    /**
     * Gets the {@link com.hh.xml.internal.ws.api.model.SEIModel} that represents the relationship
