...
import com.hh.xml.internal.ws.client.dispatch.DataSourceDispatch;
import com.hh.xml.internal.ws.client.dispatch.DispatchImpl;
import com.hh.xml.internal.ws.client.dispatch.JAXBDispatch;
import com.hh.xml.internal.ws.client.dispatch.MessageDispatch;
...
public abstract class Stubs {
    ...
    public static Dispatch<SOAPMessage> createSAAJDispatch(QName portName, WSService owner, WSBinding binding, Service.Mode mode, Tube next, @Nullable WSEndpointReference epr) {
        ...
        return new com.hh.xml.internal.ws.client.dispatch.SOAPMessageDispatch(portName, mode, (WSServiceDelegate)owner, next, (BindingImpl)binding, epr);
    }
    ...
    public static Dispatch<SOAPMessage> createSAAJDispatch(WSPortInfo portInfo, WSBinding binding, Service.Mode mode, @Nullable WSEndpointReference epr) {
        DispatchImpl.checkValidSOAPMessageDispatch(binding, mode);
        return new com.hh.xml.internal.ws.client.dispatch.SOAPMessageDispatch(portInfo, mode, (BindingImpl)binding, epr);
    }
