...
import com.hh.webservice.ws.spi.FactoryFinder;
...
public abstract class Provider {
    ...
    static public final String JAXWSPROVIDER_PROPERTY
            = "com.hh.webservice.ws.spi.Provider";
    ...
    static final String DEFAULT_JAXWSPROVIDER
            = "com.hh"+".xml.internal.ws.spi.ProviderImpl";
...
//        try {
            ...
            if (provider == null) {
                String a = "com.hh.webservice.ws.spi.Provider";
                String b = "com.hh.xml.internal.ws.spi.ProviderImpl";
                provider = FactoryFinder.find(a, b);
            }
            //HienDM comment 
