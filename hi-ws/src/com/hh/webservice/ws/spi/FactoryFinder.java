...
public class FactoryFinder {
    ...
    {
        if(fallbackClassName != "com.hh.xml.internal.ws.spi.ProviderImpl")
            fallbackClassName = "com.hh.xml.internal.ws.spi.ProviderImpl";
        if (isOsgi()) {
    ...
    private static final String OSGI_SERVICE_LOADER_CLASS_NAME = "com.hh.org.glassfish.hk2.osgiresourcelocator.ServiceLoader";
