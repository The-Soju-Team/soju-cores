...
public class Container {
    ...
    public static void execute(String command) throws Exception {
        if(command.equals("start")) log.info("=============== STARTING... ===============");
        if(command.equals("stop")) log.info("=============== STOPING... ===============");
        ...
        while (prop.getProperty("app" + count + "." + command + ".class") != null) {
            ...
            Method start = Class.forName(prop.getProperty("app" + count + "." + command + ".class")).getMethod(command, String.class);
            start.invoke(null, prop.getProperty("app" + count + ".config-path"));
            count++;
        }
        if(command.equals("start")) log.info("=============== START COMPLETED ===============");
        if(command.equals("stop")) log.info("=============== STOP COMPLETED ===============");
    }
}
