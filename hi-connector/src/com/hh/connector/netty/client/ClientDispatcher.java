...
public class ClientDispatcher extends UntypedActor {
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger
            .getLogger(ClientDispatcher.class.getSimpleName());
    ...
    public void process(Object obj) throws Exception {
        ...
        if (msg.containsKey("hi-process") && msg.get("hi-process") != null) {
            ...
            if (process != null) {
                ...
                if (server.clientFilter != null)
                    checkFilter = server.clientFilter.doFilter(msg, server);
                if (checkFilter)
...
//		if (actor == null)
//			ServerHandler.onSender(ctx, Config.responseMessage(msg, Config.ERROR_NOT_SUPPORT, "can't find hi-process!"),
//					server);
    }
}
